...
class SemanticKitti(Dataset):
  ...
  def __init__(self, root,    # directory where data is
    ...
    for seq in self.sequences:
      ...
      self.flabel_files.extend(flabel_files)
      self.fimage_files.extend(fimage_files)

    # sort for correspondance
    self.fscan_files.sort()
    self.flabel_files.sort()
    self.fimage_files.sort()
  ...
  def __getitem__(self, index):
    ...
    image_file = self.fimage_files[index]
    if self.gt:
      label_file = self.flabel_files[index]
