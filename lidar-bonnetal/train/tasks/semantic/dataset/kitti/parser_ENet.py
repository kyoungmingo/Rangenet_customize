...
class SemanticKitti(Dataset):
  ...
  def __init__(self, root,    # directory where data is
    ...
    for seq in self.sequences:
      ...
      class_path = os.path.join("/mnt/han/lidar-bonnetal/train/tasks/semantic/darknet_pre/darknet53/sequences/",seq, "predictions")
      ...
      self.class_files.extend(class_files)

    # sort for correspondance
    self.scan_files.sort()
    self.label_files.sort()
    self.class_files.sort()
  ...
  def __getitem__(self, index):
    ...
    class_file = self.class_files[index]
    if self.gt:
    ...
    if self.gt:
      scan.open_label(label_file,class_file)
