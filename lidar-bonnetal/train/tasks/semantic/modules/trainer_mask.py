...
# from tasks.semantic.modules.segmentator import *
# from tasks.semantic.modules.segmentator_attention import *
...
#굳이 이렇게 따로 dict를 불러와서 합쳐줄 필요가 있는가?
#내 생각 : CRF나 train을 안할 경우가 있기 때문에
